function(cppcheck_sources target_name sources)
    ...
    if (NOT CPPCHECK)
        message(SEND_ERROR "Failed to find cppcheck - is it in your PATH?")
    endif()
    
    find_package(Python3)
    if (NOT Python3_FOUND)
        message(SEND_ERROR "Failed to find 'python3'. It is required to use cppcheck")
    endif()

    if (NOT CMAKE_EXPORT_COMPILE_COMMANDS)
        message(SEND_ERROR "'CMAKE_EXPORT_COMPILE_COMMANDS' is not set. It is required to use cppcheck")
    endif()
    ...
    if (NOT EXISTS "${FILTER_COMPILE_COMMANDS_SCRIPT}")
        message(SEND_ERROR "'${FILTER_COMPILE_COMMANDS_SCRIPT}' does not exist. It is required to use cppcheck")
    endif()
